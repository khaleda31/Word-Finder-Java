...
public interface IWordMap {
	 ...
	 * 
	 * @throws WordException if no entry with word in the map.
	 */
	 ...
	 * 
	 * @throws WordException if no entry with word in the map or if word is not
	 * associated with given position.
	 */
