...
/*
 * This class is for reading words form an input file. Create an object of the
 * class WordTxtReader by providing a file name:
 * {@code WordTxtReader readWords = new WordTxtReader("filename.txt");} To read
 * a word, first check that there is a next word in the file:
 * {@code if (readWords.hasNextWord()) } Finally, to read a word, use:
 * {@code WordPosition nextWord = readWords.nextWord(); }
 * 
 */
public class WordTxtReader {
	 ...
	 * 
	 * @param inputFileName The name of the file to read words from
	 */
